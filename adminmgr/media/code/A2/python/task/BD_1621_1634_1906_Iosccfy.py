...
if __name__ == "__main__":
	...
	# Initialize the spark context.
        ...
        links = lines.map(lambda batsman: parseNeighbors(batsman,0)).distinct().groupByKey().cache()
        
        links1=lines.map(lambda batsman: parseNeighbors(batsman,1)).distinct().groupByKey().cache()
