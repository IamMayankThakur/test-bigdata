...
public class BD_2362_2415_2416_2491 {
    ...
    public static class BatsmanVulMapper extends Mapper<Object, Text, Text, Text> {
    ...
    public static class BatsmanCombiner extends Reducer<Text, Text, Text, Text> {
    ...
    public static class BatsmanVulReducer extends Reducer<Text, Text, Text, Text> {
