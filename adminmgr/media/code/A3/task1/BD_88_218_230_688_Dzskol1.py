...
sqlDF1=spark.sql("SELECT Hashtags,COUNT(Hashtags) AS count FROM data GROUP BY Hashtags ORDER BY count DESC LIMIT 5")
query1=sqlDF1.writeStream.format("console").outputMode("complete").start()
