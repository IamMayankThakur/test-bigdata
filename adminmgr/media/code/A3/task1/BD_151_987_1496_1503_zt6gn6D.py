...
inputDF = spark.readStream.schema(schema).option("delimiter",";")
...
query1.writeStream.outputMode("complete").format("console").option("numRows",5).start().awaitTermination(60)
#query1.stop()
