...
count=h.groupby("Hashtags").count()

common1=count.select("Hashtags","count").orderBy("count",ascending=False).limit(5)

query=common1.writeStream.outputMode("complete").format("console").start()
