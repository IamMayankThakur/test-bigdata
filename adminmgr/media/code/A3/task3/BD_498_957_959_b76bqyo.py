...
line = dataStream.flatMap(lambda x:get_hashtag(x))

data = line.reduceByKeyAndWindow(lambda x, y: x + y, lambda x, y: x - y, window_size, 1).transform(lambda z: z.sortBy(lambda x: x[1] ,ascending=False))
