			...
			for i in l:
				if(c<5):
					if(i[0] !=''):
						hashtag.append(i[0])
						c=c+1
			print("%s,%s,%s,%s,%s"%(hashtag[0],hashtag[1],hashtag[2],hashtag[3],hashtag[4]))
