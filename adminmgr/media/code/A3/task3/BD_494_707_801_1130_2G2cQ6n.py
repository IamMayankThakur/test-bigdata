...
FollCounter = spark.sql("SELECT Name as name, (first_value(Followers)/first_value(Friends)) as FRRatio FROM FollowerView GROUP BY name ORDER BY FRRatio DESC LIMIT 1")
