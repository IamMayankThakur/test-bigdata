...
"string").add("UserMentionNames","string").add("UserMentionID","string").add("Name","string").add("Place","string").add("Followers","integer").add("Friends","integer")
...
w1=spark.sql("select Name as name , max(Followers/Friends) as FRRatio from updates group by name order by FRRatio desc limit 1")
