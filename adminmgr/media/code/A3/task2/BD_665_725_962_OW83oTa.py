...
Hashtag_counts_dataframe=spark_session_object.sql("select Name as name,MAX(Followers/Friends) as FRRatio from DataTable group by name order by FRRatio desc limit 5")
