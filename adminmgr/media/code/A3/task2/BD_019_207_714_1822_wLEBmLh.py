...
schema1 = StructType([
	...
	StructField('rrts', IntegerType(), True),
...
count_dataframe = spark_obj.sql("select Name as name,MAX(Followers/Friends) as FRRatio from table group by name order by FRRatio desc limit 1")
